        ...
        "/api/v1/comments/by/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "id of comment to be gotten",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CommentForUpdate"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/users/by/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "id of user to be gotten",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "models.User": {
            ...
            "properties": {
                ...
                "posts": {
                    "description": "user hasMany  Post  เอา  user_id",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.Posts"
                    }
